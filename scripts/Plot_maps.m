...
plot=[BMI_both, BMIarea_both, dasb_both, fpcit_both, ec1r_both];
plot_hemispheres(plot, {'/dagher/dagher11/filip/Obesity_maps/data/lh.white', '/dagher/dagher11/filip/Obesity_maps/data/rh.white'}, 'views','lmap','labeltext',{'BMI - CT','BMI - SA','5-HTT','DAT','CB1R'});

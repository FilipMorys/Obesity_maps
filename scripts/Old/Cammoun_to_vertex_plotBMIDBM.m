...
% Import the data
PLS2ROIscoresBMIDBMLH = readtable("/dagher/dagher11/filip/Obesity_maps/Final_results/PLS2_ROIscores_BMI_DBM_LH_Cammoun.csv", opts);
...
plsroi=plot_hemispheres(vertex_img', {'/dagher/dagher11/filip/Obesity_maps/data/lh.white'}, 'views','lmap','labeltext',{'Component 2 scores'});
hold on

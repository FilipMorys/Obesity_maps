...
% Import the data
PLS2ROIscoresBMIDBMLH = readtable("/dagher/dagher11/filip/Obesity_maps/Final_results/PLS1_ROIscores_BMI_thickness_Cammoun_LH.csv", opts);
...
plsroi=plot_hemispheres(vertex_img', {'/dagher/dagher11/filip/Obesity_maps/data/lh.white'}, 'views','lmap','labeltext',{'Component 1 scores'});
hold on
%colormap redblue

exportgraphics(gcf,'Component1_thickness.tif','Resolution',300)
...
PLS2geneWeightsBMIDBMLHCammoun=sortrows(PLS2geneWeightsBMIDBMLHCammoun); % sort genes alphabetically so they correspond to entrezIDs
rm_idx=cellfun(@(a) strmatch(a,PLS2geneWeightsBMIDBMLHCammoun.gene,'exact'),removed_genes,'uniform',false); %find indices of genes that were removed due to missing entrezIDs

PLS2_removedgenes=PLS2geneWeightsBMIDBMLHCammoun; %remove those genes from our PLS results

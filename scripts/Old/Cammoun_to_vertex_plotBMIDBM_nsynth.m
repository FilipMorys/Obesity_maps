...
% Import the data
PLS1ROIscoresBMIDBMLH = readtable("/dagher/dagher11/filip/Obesity_maps/Final_results/PLS1_ROIscores_BMI_Cammoun_thickness_LHRH.csv", opts);
...
PLS1_plot_LH=table(PLS1ROIscoresBMIDBMLH.VarName1(109:219),ct_dkt_lh.table([2:4 6:113],5));
